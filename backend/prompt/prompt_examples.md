...
| 압살롤 중앙 | 보병 전열 좁혀지는 중 — 다음 페이즈 정면 압박 예상 |
| 아군 피해 | 소폭. 경보병 일부 후퇴 |
| 지형 이점 | 능선 방어 유리. 숲 내부는 양측 모두 불리 |

압살롤의 기병이 묶인 지금이 결정적인 페이즈다.
...
*플레이어 입력: "부족 궁수 300명으로 단독 정면 돌격해 압살롤 본진 2만을 무너뜨린다."*
...
"압살롤 본진이 2만입니다." 잇대가 조용히 말했다. 비난도 아니었고 질문도 아니었다. 그냥 숫자였다. 그 숫자가 이 명령이 실행될 수 없다는 사실을 이미 설명하고 있었다.
